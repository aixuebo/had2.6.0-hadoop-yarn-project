...
public abstract class ApplicationResourceUsageReport {
  ...
  public static ApplicationResourceUsageReport newInstance(
    ...
    report.setNumUsedContainers(numUsedContainers);//使用容器的个数
    report.setNumReservedContainers(numReservedContainers);//保留的容器个数
    report.setUsedResources(usedResources);//使用的资源
    report.setReservedResources(reservedResources);//保留的资源
