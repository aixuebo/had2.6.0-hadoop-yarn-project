...
public class SchedulerAppReport {
  ...
  private final Collection<RMContainer> live;//该任务正在运行的容器数量
  private final Collection<RMContainer> reserved;//该容器申请预留容器数量
  private final boolean pending;//该应用是否尚未启动.true表示尚未启动该任务
