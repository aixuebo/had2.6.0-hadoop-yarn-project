...
public abstract class AbstractYarnScheduler
  ...
  // Nodes in the cluster, indexed by NodeId 集群中的node节点映射
  ...
  /**
   * 通过nodeId,获取该节点的信息,比如该节点已经使用磁盘大小、未使用大小、该节点有多少个contain
   */
  @Override
