...
public class ResourceManager extends CompositeService implements Recoverable {
  ...
  //配置文件提供器,本地加载或者jar包内加载,或者hdfs上加载指定path下的配置文件,返回输入流
  ...
  protected void serviceInit(Configuration conf) throws Exception {
    ...
    // Do refreshUserToGroupsMappings with loaded core-site.xml 获得user-group对应关系
  ...
  /**
   * 每一个ApplicationAttempt应用实例需要处理的事件
   */
  @Private
