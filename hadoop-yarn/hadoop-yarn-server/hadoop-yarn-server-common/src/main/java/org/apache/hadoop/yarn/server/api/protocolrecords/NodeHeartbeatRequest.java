...
public abstract class NodeHeartbeatRequest {
  ...
  public static NodeHeartbeatRequest newInstance(NodeStatus nodeStatus,
    ...
    nodeHeartbeatRequest.setNodeStatus(nodeStatus);//收集的节点的一些元数据信息
    nodeHeartbeatRequest.setLastKnownContainerTokenMasterKey(lastKnownContainerTokenMasterKey);//当前的密钥
    nodeHeartbeatRequest.setLastKnownNMTokenMasterKey(lastKnownNMTokenMasterKey);//当前的密钥
