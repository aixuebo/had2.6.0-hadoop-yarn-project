 ...
 * nodeManager的审计日志,即每个信息的日志
 */
public class NMAuditLogger {
  private static final Log LOG = LogFactory.getLog(NMAuditLogger.class);

  static enum Keys {USER, OPERATION, TARGET, RESULT, IP,DESCRIPTION, APPID, CONTAINERID} 

  public static class AuditConstants {
    static final String SUCCESS = "SUCCESS";//结果是成功
    static final String FAILURE = "FAILURE";//结果是失败
   ...
   * user=value \t ip=value \t OPERATION=value \t TARGET=value \t RESULT=结果 \t appid=value \t containerId=value
   */
   ...
   * user=value \t ip=value \t OPERATION=value \t TARGET=value \t RESULT=结果 \t DESCRIPTION=value \t appid=value \t containerId=value
   */
